...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UIKit processing");
    
    let mut processor = UIKitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UIKitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UIKitProcessor::new(false);
